<template>
    <div class="playList" :class="{view: songList.length > 0}">
        <div class="fixed-title" :style="{'background': 'rgba(206, 61, 62, '+ opacity +')'}" style="transition: opacity .1s;">
            <mu-appbar>
            <mu-icon-button class='iconfont icon-fanhui' @click="back" slot="left"/>
        ...
        <div class="playlist-holder">
            <div class="add-all">
              <i class="demo-flat-button iconfont icon-jiahao" @click="playAll">播放全部</i>
            </div>
            <div>
...
export default {
  data () {
    return {
      coverImgUrl: 'https://gggqqqxxx.github.io/CloudMusic/static/default_cover.png',
      name: '歌单标题',
      id: 0,
      fname: '歌单',
      playCount: 0,
      description: '描述描述',
      creator: {
        'avatarUrl': 'https://gggqqqxxx.github.io/CloudMusic/static/user-default.png',
        'nickname': '昵称'
      },
      list: [],
      opacity: 0,
